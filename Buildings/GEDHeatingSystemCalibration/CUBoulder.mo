...
First implementation.
      ...
      model HeatBalanceBoilerWithEconomizerClosedLoop
          extends Modelica.Icons.Example;
        ...
        Fluid.Actuators.Dampers.PressureIndependent damPreInd(redeclare package
            Medium = MediumAir) annotation (Placement(transformation(
              ...
              rotation=90,
              origin={66,-30})));
        Fluid.Actuators.Dampers.PressureIndependent damPreInd1(redeclare
            package Medium = MediumAir) annotation (Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=0,
              origin={32,-60})));
        Fluid.Actuators.Dampers.PressureIndependent damPreInd2(redeclare
            package Medium = MediumAir) annotation (Placement(transformation(
              extent={{-10,-10},{10,10}},
              rotation=0,
              origin={-70,-92})));
      ...
      equation
        ...
        annotation (__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/GEDCalibration/CUBoulder/Components/HeatBalanceBoiler.mos"
          ...
          experiment(Tolerance=1e-6, StopTime=3600),Icon(coordinateSystem(preserveAspectRatio=false, extent={{-200,-200},
                  {160,100}})),                                        Diagram(
              coordinateSystem(preserveAspectRatio=false, extent={{-200,-200},{160,100}})));
      end HeatBalanceBoilerWithEconomizerClosedLoop;
      ...
      model BoilerPlantWithDemand
        ...
        Experimental.DHC.Loads.Steam.BaseClasses.SteamTrap steTra(redeclare
      ...
      model BoilerWithEconomizerDynamicTest2
        extends Modelica.Icons.Example;
      ...
      //setpoints
       parameter Modelica.Units.SI.Volume VBoiWatSet=V/2
        ...
        Fluid.Sources.Boundary_pT sin(
          ...
          T=453.15,
          nPorts=1) "Sink"
          annotation (Placement(transformation(extent={{212,-158},{192,-138}})));
        Modelica.Blocks.Sources.Constant ecoValSig(k=1)
        ...
        Modelica.Blocks.Sources.CombiTimeTable
          ...
          columns=2:15,
          extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
          annotation (Placement(transformation(extent={{370,-78},{390,-58}})));
        Modelica.Blocks.Sources.CombiTimeTable T_FW(
          tableOnFile=true,
          tableName="table",
          fileName=ModelicaServices.ExternalReferences.loadResource(data),
        ...
        Fluid.FixedResistances.PressureDrop res1(
          ...
          m_flow_nominal=m1_flow_nominal,
          dp_nominal=10000)
          annotation (Placement(transformation(extent={{132,-158},{152,-138}})));
      ...
      equation
        ...
        connect(val2.port_a, fwPum.port_b) annotation (Line(
            ...
            color={0,127,255},
            thickness=0.5));
        connect(val2.port_b, boi.port_a2) annotation (Line(points={{-26,-10},{-26,-148},
                {12,-148}}, color={0,127,255},
            thickness=0.5));
        connect(val.port_a, fwPum.port_b) annotation (Line(
            points={{40,20},{-50,20}},
            color={0,127,255},
        ...
        connect(sou.ports[1], fwPum.port_a) annotation (Line(
            ...
            thickness=0.5));
        connect(val1.port_b, boi.port_a2) annotation (Line(
            points={{40,-26},{-26,-26},{-26,-148},{12,-148}},
            color={0,127,255},
            thickness=0.5));
        connect(TAmb.port, boi.heatPort)
        ...
        connect(ecoValSig.y, val.y) annotation (Line(
            ...
            pattern=LinePattern.Dash));
        connect(ecoValSig.y, val1.y) annotation (Line(
            points={{-119,100},{60,100},{60,-6},{50,-6},{50,-14}},
            color={0,0,127},
            pattern=LinePattern.Dash));
        connect(valSig.y, val2.y) annotation (Line(
            points={{-119,-10},{-46,-10},{-46,6.66134e-16},{-38,6.66134e-16}},
            color={0,0,127},
            pattern=LinePattern.Dash));
        connect(plr.y[1], boi.y) annotation (Line(points={{-119,-40},{-24,-40},
                {-24,-124},{4,-124},{4,-136},{10,-136}},
                           color={0,0,127},
            pattern=LinePattern.Dash));
        connect(senTem2.port_b, res1.port_a) annotation (Line(
            points={{116,-148},{132,-148}},
            color={238,46,47},
            thickness=0.5));
        connect(res1.port_b, sin.ports[1]) annotation (Line(
            points={{152,-148},{188,-148},{188,-148},{192,-148}},
            color={238,46,47},
            thickness=0.5));
        connect(T_FW.y[1], sou.T_in) annotation (Line(
            points={{-119,16},{-102,16}},
        ...
        connect(eco.port_a1, senTem1.port_b)
          annotation (Line(points={{100,-20},{100,-82}}, color={0,0,0},
            thickness=0.5));
        connect(yMa.y[1], maDam.y) annotation (Line(points={{-119,-80},{-90,-80},
                {-90,-128}},                color={0,0,127},
            pattern=LinePattern.Dash));
        connect(ySta.y[1], staDam.y)
          annotation (Line(points={{139,32},{112,32}}, color={0,0,127},
            pattern=LinePattern.Dash));
        connect(yFgr.y[1], fgrDam.y)
          annotation (Line(points={{139,-50},{48,-50},{48,-64}}, color={0,0,127},
            pattern=LinePattern.Dash));
        connect(fgrDam.port_a, senTem1.port_b) annotation (Line(points={{58,-76},{100,
                -76},{100,-82}}, color={0,0,0},
            thickness=0.5));
        connect(fgrDam.port_b, senTem4.port_a)
          annotation (Line(points={{38,-76},{20,-76}}, color={0,0,0},
            thickness=0.5));
        connect(senTem4.port_b, senTem3.port_b) annotation (Line(points={{0,-76},{-34,
                -76},{-34,-140},{-22,-140}}, color={0,0,0},
            thickness=0.5));
        connect(maDam.port_b, senTem5.port_b)
          annotation (Line(points={{-80,-140},{-72,-140}}, color={141,137,137},

            thickness=0.5));
        connect(senTem5.port_a, senTem3.port_b)
          annotation (Line(points={{-52,-140},{-22,-140}}, color={141,137,137},

            thickness=0.5));
        connect(pro.ports[1], hea.port_a)
          annotation (Line(points={{-200,-140},{-160,-140}}, color={141,137,137},

            thickness=0.5));
        connect(hea.port_b, maDam.port_a)
          annotation (Line(points={{-140,-140},{-100,-140}}, color={141,137,137},

            thickness=0.5));
        connect(T_ma.y[1], hea.TSet) annotation (Line(points={{-199,-100},{-168,
                -100},{-168,-132},{-162,-132}},
                                          color={0,0,127},
            pattern=LinePattern.Dash));
        connect(m_fw_nom.y, fwPum.m_flow_in)
        ...
        connect(feedwaterSingleElementControl.y, m_fw_nom.u) annotation (Line(
            points={{-117,60},{-97.2,60}},
            color={0,0,127},
            pattern=LinePattern.Dash));
        connect(boi.VLiq, feedwaterSingleElementControl.VWatBoi) annotation (
            Line(
            points={{33,-152},{40,-152},{40,-100},{-10,-100},{-10,80},{-148,80},
                {-148,60},{-140,60}},
            color={0,0,127},
            pattern=LinePattern.Dash));
        annotation (
          __Dymola_Commands(file="modelica://Buildings/Resources/Data/GEDCalibration/Scripts/BoilerWithEconomizerClosedLoop.mos"
              "Simulate and plot"),
          experiment(
            StartTime=23328000,
            StopTime=25056000,
          ...
          Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-200,-200},{160,
                  100}})));
      end BoilerWithEconomizerDynamicTest2;
      ...
      //setpoints
       parameter Modelica.Units.SI.Volume VBoiWatSet=V/2
        ...
        Fluid.Sources.Boundary_pT sou(
          ...
          use_T_in=true,
          T=303.15,
          nPorts=2) "Source" annotation (Placement(transformation(
              extent={{10,-10},{-10,10}},
              rotation=180,
              origin={-240,38})));
        Components.BoilerPolynomialFurnaceHeatBalance boi(
        ...
        Modelica.Blocks.Sources.CombiTimeTable T_FW(
          ...
          columns={3},
          extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic)
          annotation (Placement(transformation(extent={{-302,24},{-282,44}})));
        Fluid.FixedResistances.PressureDrop res1(
          redeclare package Medium = MediumSte,
          m_flow_nominal=m1_flow_nominal,
          dp_nominal=10000)
        ...
        Fluid.Sensors.MassFlowRate senMasFlo(redeclare final package Medium =
              MediumWat) "Mass flow rate sensor"
          annotation (Placement(transformation(extent={{242,-198},{222,-218}})));
        Fluid.Movers.SpeedControlled_y pumCNR(
          redeclare final package Medium = MediumWat,
          energyDynamics=energyDynamics,
          final per=perPumCNR,
          y_start=1) "Condensate return pump"
          annotation (Placement(transformation(extent={{202,-218},{182,-198}})));
        Buildings.Controls.Continuous.LimPID conPumCNR(
          controllerType=Modelica.Blocks.Types.SimpleController.PI,
          k=1,
          Ti=15) "Controller"
        ...
        Fluid.FixedResistances.PressureDrop res(
          ...
          final m_flow_nominal=m1_flow_nominal,
          final dp_nominal=dpPip) "Resistance in district network"
          annotation (Placement(transformation(extent={{120,-218},{100,-198}})));
      equation
        ...
        connect(val.port_a, fwPum.port_b) annotation (Line(
            ...
            thickness=0.5));
        connect(sou.ports[1], fwPum.port_a) annotation (Line(
            points={{-230,39},{-76,39},{-76,20},{-70,20}},
            color={0,127,255},
            thickness=0.5));
        connect(val1.port_b, boi.port_a2) annotation (Line(
            points={{40,-40},{-26,-40},{-26,-148},{12,-148}},
            color={0,127,255},
            thickness=0.5));
        connect(TAmb.port, boi.heatPort)
          annotation (Line(points={{140,-110},{22,-110},{22,-134}},
        ...
        connect(ecoValSig.y, val.y) annotation (Line(
            ...
            pattern=LinePattern.Dash));
        connect(ecoValSig.y, val1.y) annotation (Line(
            points={{-119,100},{60,100},{60,-6},{50,-6},{50,-28}},
            color={0,0,127},
            pattern=LinePattern.Dash));
        connect(valSig.y, val2.y) annotation (Line(
            points={{-159,-10},{-46,-10},{-46,6.66134e-16},{-38,6.66134e-16}},
            color={0,0,127},
            pattern=LinePattern.Dash));
        connect(plr.y[1], boi.y) annotation (Line(points={{-159,-50},{-24,-50},{-24,-124},
                {4,-124},{4,-136},{10,-136}},
                           color={0,0,127},
            pattern=LinePattern.Dash));
        connect(senTem2.port_b, res1.port_a) annotation (Line(
        ...
        connect(eco.port_a1, senTem1.port_b)
          annotation (Line(points={{100,-20},{100,-90}}, color={0,0,0},
            thickness=0.5));
        connect(yMa.y[1], maDam.y) annotation (Line(points={{-159,-80},{-90,-80},{-90,
                -128}},                     color={0,0,127},
            pattern=LinePattern.Dash));
        connect(ySta.y[1], staDam.y)
          annotation (Line(points={{139,32},{112,32}}, color={0,0,127},
        ...
        connect(senTem4.port_b, senTem3.port_b) annotation (Line(points={{0,-80},{-34,
            ...
            thickness=0.5));
        connect(maDam.port_b, senTem5.port_b)
          annotation (Line(points={{-80,-140},{-70,-140}}, color={141,137,137},
            thickness=0.5));
        connect(senTem5.port_a, senTem3.port_b)
        ...
        connect(pro.ports[1], hea.port_a)
          annotation (Line(points={{-160,-140},{-140,-140}}, color={141,137,137},
            thickness=0.5));
        connect(hea.port_b, maDam.port_a)
          annotation (Line(points={{-120,-140},{-100,-140}}, color={141,137,137},
            thickness=0.5));
        connect(T_ma.y[1], hea.TSet) annotation (Line(points={{-159,-110},{-148,-110},
                {-148,-132},{-142,-132}}, color={0,0,127},
            pattern=LinePattern.Dash));
        connect(m_fw_nom.y, fwPum.m_flow_in)
          annotation (Line(points={{-83.4,60},{-60,60},{-60,32}},
                                                                color={0,0,127},
        ...
        connect(boi.VLiq, feedwaterSingleElementControl.VWatBoi) annotation (Line(
            ...
            pattern=LinePattern.Dash));
        connect(senMasFlo.m_flow,conPumCNR. u_m) annotation (Line(
            points={{232,-219},{232,-224},{306,-224},{306,-180}},
            color={0,0,127},
            pattern=LinePattern.Dash));
        connect(conPumCNR.y,pumCNR. y) annotation (Line(
            points={{295,-168},{192,-168},{192,-196}},
            color={0,0,127},
            pattern=LinePattern.Dash));
        connect(conPumCNR.u_s,mFloFW2. y[1])
          annotation (Line(points={{318,-168},{343,-168}}, color={0,0,127}));
        connect(pumCNR.port_b,res. port_a)
          annotation (Line(points={{182,-208},{120,-208}},color={0,127,255}));
        connect(res1.port_b, prv.port_a)
        ...
        connect(steTra.port_b, senMasFlo.port_a) annotation (Line(points={{262,-188},{
                262,-208},{242,-208}}, color={0,127,255}));
        connect(senMasFlo.port_b, pumCNR.port_a)
          annotation (Line(points={{222,-208},{202,-208}}, color={0,127,255}));
        connect(res.port_b, sou.ports[2]) annotation (Line(points={{100,-208},{-216,-208},
                {-216,37},{-230,37}}, color={0,127,255}));
        annotation (
          __Dymola_Commands(file="modelica://Buildings/Resources/Data/GEDCalibration/Scripts/BoilerWithEconomizerClosedLoop.mos"
              "Simulate and plot"),
          experiment(
  ...
  package Controls
    ...
    block FeedwaterSingleElementControl
      ...
      Buildings.Controls.Continuous.LimPID conPum(
        ...
        annotation (Placement(transformation(extent={{10,10},{-10,-10}},
            rotation=180,
            origin={10,0})));
      Modelica.Blocks.Math.Gain PNor(final k=1/VBoiWatSet)
        "Normalized pressure setpoint" annotation (Placement(transformation(
            extent={{10,-10},{-10,10}},
            rotation=180,
            origin={-30,-40})));
      Modelica.Blocks.Interfaces.RealInput VWatBoi "Volume of water in the boiler"
      ...
      //setpoints
     parameter Modelica.Units.SI.Volume VBoiWatSet= 1
        "Setpoint for liquid water volume in the boiler";
    ...
    equation
      ...
      Diagram(coordinateSystem(preserveAspectRatio=false)));
    end FeedwaterSingleElementControl;

    block FeedwaterThreeElementControl
      annotation (Icon(coordinateSystem(preserveAspectRatio=false), graphics={
              Text(
              extent={{-70,50},{76,-64}},
              textColor={0,127,255},
              textString="FW3EleCon
")}), Diagram(coordinateSystem(preserveAspectRatio=false)));
    end FeedwaterThreeElementControl;
