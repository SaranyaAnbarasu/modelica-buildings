within Buildings;
package GEDHeatingSystemCalibration
...
</html>"),Diagram(coordinateSystem(extent={{-240,-100},{200,100}})),
...
</html>"),Diagram(coordinateSystem(extent={{-160,-100},{60,100}})),
...
First implementation.
  ...
  saturated steam vapor, with the efficiency curve described by a polynomial."
    ...
    (only used if efficiency curve depends on temperature)";
      ...
      public
        Modelica.Blocks.Sources.RealExpression mExhFlow(y=((mFueFlo/furHeaBal.fs)
               + mFueFlo)) "Heat losses in the exhaust"
          annotation (Placement(transformation(extent={{-100,-2},{-80,18}})));
      ...
      package Validation
        ...
        package Boiler
          model BoilerPolynomialFurnaceHeatBalance
            ...
            Fluid.Sources.Boundary_pT           sou2(redeclare package Medium
                =                                                               MediumAir,
              T(displayUnit="K") = 577,
                nPorts=1)
              "Source"
...
First implementation.
    ...
    package SubSystems
      package Validation
        model HeatBalanceBoilerWithEconomizer
            extends Modelica.Icons.Example;
          ...
          Modelica.Blocks.Sources.SawTooth Tair_in(
            amplitude=80,
            period=2000,
            offset=273)
          ...
          Modelica.Blocks.Sources.SawTooth
                                        sawTooth(amplitude=1, period=2000)
        ...
        equation
          connect(mFloFW.y,fwPum. m_flow_in)
            annotation (Line(points={{-179,-30},{-110,-30},{-110,-38}},
                                                                     color={0,0,127},
              pattern=LinePattern.Dash));
          connect(Tair_in.y, pro.T_in) annotation (Line(
              points={{-179,14},{-162,14}},
              color={0,0,127},
              pattern=LinePattern.Dash));
          connect(fwPum.port_b, boi.port_a2) annotation (Line(points={{-100,-50},{
                  -80,-50},{-80,-14},{-72,-14}},
                                  color={0,127,255},
              thickness=0.5));
          connect(TAmb.port, boi.heatPort) annotation (Line(points={{-32,40},{-62,
                  40},{-62,0}},
                            color={191,0,0}));
          connect(sawTooth.y, boi.y) annotation (Line(
              points={{-179,50},{-100,50},{-100,12},{-80,12},{-80,-2},{-74,-2}},
              color={0,0,127},
              pattern=LinePattern.Dash));
          connect(boi.port_b1, senTem.port_b) annotation (Line(
              points={{-52,-6},{-30,-6}},
          ...
          connect(pro.ports[1], senTem1.port_b) annotation (Line(
              ...
              thickness=0.5));
          connect(senTem1.port_a, boi.port_a1) annotation (Line(
              points={{-110,10},{-82,10},{-82,-6},{-72,-6}},
              color={0,0,0},
              thickness=0.5));
          connect(boi.port_b2, senTem2.port_b) annotation (Line(
              points={{-52,-14},{-46,-14},{-46,-50},{-40,-50}},
              color={238,46,47},
              thickness=0.5));
          connect(senTem2.port_a, sin.ports[1]) annotation (Line(
              points={{-20,-50},{-12,-50}},
              color={238,46,47},
              thickness=0.5));
          connect(senTem.port_a, hex.port_a1) annotation (Line(
              points={{-10,-6},{30,-6}},
              color={0,0,0},
              thickness=1));
          connect(hex.port_b1, exh.ports[1]) annotation (Line(
              points={{50,-6},{70,-6}},
              color={0,0,0},
              thickness=1));
          connect(hex.port_b2, fwPum.port_a) annotation (Line(
              points={{30,-18},{20,-18},{20,-80},{-140,-80},{-140,-50},{-120,-50}},
              color={0,127,255},
              thickness=0.5));

          connect(hex.port_a2, sou.ports[1]) annotation (Line(
              points={{50,-18},{58,-18},{58,-32},{70,-32}},
              color={0,127,255},
              thickness=0.5));
          connect(Tfw_in.y, sou.T_in) annotation (Line(
              points={{115,-36},{92,-36}},
              color={0,0,127},
              pattern=LinePattern.Dash));
          annotation (__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/GEDCalibration/CUBoulder/Components/HeatBalanceBoiler.mos"
            ...
            experiment(Tolerance=1e-6, StopTime=3600),Icon(coordinateSystem(preserveAspectRatio=false, extent={{-200,-200},
                    {160,100}})),                                        Diagram(
                coordinateSystem(preserveAspectRatio=false, extent={{-200,-200},{160,100}})));
        end HeatBalanceBoilerWithEconomizer;
...
end GEDHeatingSystemCalibration;
